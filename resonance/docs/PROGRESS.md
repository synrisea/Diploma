...
4. Tests: `services/topics-service/tests/test_itinerary.py` (pytest, mocks the LLM call) and `frontend/src/lib/{geo,routeOrdering}.test.ts` (vitest) — both new, neither test framework existed in this project before this feature.
