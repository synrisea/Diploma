  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5">
        <span
          className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 font-mono text-[10px] uppercase tracking-[0.1em] text-white"
          style={{ backgroundColor: style.color }}
        >
          {style.label}
        </span>

        <h2 className="mt-3 font-display text-xl text-stone-900">{place.name}</h2>
